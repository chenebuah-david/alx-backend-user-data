...
def unauthorized(error) -> str:
    """This is the unauthorized error handler
    """
...
def unauthorized(error) -> str:
    """This is the forbidden error handler
    """
...
def users() -> str:
    """
    This registers a new user route
    """
...
def login():
    """This log's in a valid user and set a session ID
    """
    email, password = request.form.get('email'), request.form.get('password')
...
def profile():
    """This gets and returns json data of user profile
    """
    session_id = request.cookies.get("session_id")
    user = AUTH.get_user_from_session_id(session_id)
    if user:
