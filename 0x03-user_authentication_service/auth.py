#!/usr/bin/env python3
"""
This is the Definition of _hash_password function
"""
import bcrypt
...
def _hash_password(password: str) -> bytes:
    """
    This hashes a password string and returns it in bytes form
    Args:
...
def _generate_uuid() -> str:
    """
    This generates a uuid and return its string representation
    """
    return str(uuid4())


class Auth:
    """This is the authentication class to interact with
    ...
    def register_user(self, email: str, password: str) -> User:
        """
        This registers a new user and return a user object
        Args:
    ...
    def create_session(self, email: str) -> Union[None, str]:
        """
        This create a session_id for an existing user and update the user's
    ...
    def destroy_session(self, user_id: int) -> None:
        """
        This takes a user_id and destroy that user's session
        and update their session_id attribute to None
        Args:
    ...
    def get_reset_password_token(self, email: str) -> str:
        """
        This generates a reset_token uuid for a user
    ...
    def update_password(self, reset_token: str, password: str) -> None:
        """
        This updates a user's password
        Args:
